    ...
    return /*#__PURE__*/function (_Wrapper) {
      ...
      _createClass(WrapperEx, [{
        ...
        value: function getCurrentData() {
          return !!this.getActionDomElement().checked;
        }
      }, {
        ...
        value: function onClick(a_event) {
          this.setArg("value", this.getCurrentData());
        }
      }, {
        key: "onArgValue",
        value: function onArgValue(a_value) {
          var checked = a_value == true || a_value == 1;
          this.getActionDomElement().checked = checked;
          if (checked) this.getActionDomElement().setAttribute("checked", "checked");else this.getActionDomElement().removeAttribute("checked");
        }
      }]);
