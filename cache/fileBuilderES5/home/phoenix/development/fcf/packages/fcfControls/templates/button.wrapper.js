  ...
  module: function module(Wrapper) {
    return /*#__PURE__*/function (_Wrapper) {
      ...
      _createClass(WrapperEx, [{
        ...
        key: "onArgTitle",
        value: function onArgTitle(a_value) {
        ...
        value: function onArgEnable(a_value) {
          if (a_value) this.getActionDomElement().removeAttribute("disabled");else this.getActionDomElement().setAttribute("disabled", "disabled");
        }
      }]);
