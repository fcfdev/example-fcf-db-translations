...
fcf.module({
  ...
  module: function module(Wrapper) {
    return /*#__PURE__*/function (_Wrapper) {
      ...
      _inherits(NavigatorWrapper, _Wrapper);

      var _super = _createSuper(NavigatorWrapper);

      function NavigatorWrapper(a_initializeOptions) {
        _classCallCheck(this, NavigatorWrapper);

        return _super.call(this, a_initializeOptions);
      }

      _createClass(NavigatorWrapper, [{
        key: "onArg",
