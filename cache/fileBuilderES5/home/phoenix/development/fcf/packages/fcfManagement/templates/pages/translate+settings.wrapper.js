...
fcf.module({
  name: "fcfManagement:templates/pages/translate+settings.wrapper.js",
    ...
    return /*#__PURE__*/function (_Wrapper) {
      ...
      _createClass(WrapperEx, [{
        ...
        value: function onSave() {
          var self = this;
          this.send({
            languageIdentification: this.getArg("languageIdentification"),
            defaultLanguage: this.getArg("defaultLanguage")
          }).then(function () {
